...
namespace AutoEdge.Migrations
{
    ...
    [Migration("20251017111331_AddEmploymentOnboardingEntities")]
    partial class AddEmploymentOnboardingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.ServiceInvoice", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ServiceInvoiceId"));
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.ServiceSchedule", b =>
                {
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.VehicleInspection", b =>
                {
                    ...
                    b.Property<string>("DamageDocumentation")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("InspectionPhotos")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("RequiredMaintenance")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.ServiceInvoice", b =>
                {
                    ...
                    b.HasOne("AutoEdge.Models.Entities.ServiceExecution", "ServiceExecution")
                        .WithMany()
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.ServiceSchedule", b =>
                {
                    b.HasOne("AutoEdge.Models.Entities.ApplicationUser", "Mechanic")
                        .WithMany()
            ...
            modelBuilder.Entity("AutoEdge.Models.Entities.VehicleInspection", b =>
                {
                    b.HasOne("AutoEdge.Models.Entities.ApplicationUser", "Inspector")
                        .WithMany()
